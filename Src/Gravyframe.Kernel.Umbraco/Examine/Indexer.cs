...
namespace Gravyframe.Kernel.Umbraco.Examine
{
    public class Indexer : BaseUmbracoIndexer
    {
		...
		public Indexer(IIndexCriteria indexerData, DirectoryInfo indexPath, IDataService dataService, Analyzer analyzer, bool async)
		...
		[SecuritySafeCritical]
        public Indexer(IIndexCriteria indexerData, Lucene.Net.Store.Directory luceneDirectory, IDataService dataService, Analyzer analyzer, bool async)
