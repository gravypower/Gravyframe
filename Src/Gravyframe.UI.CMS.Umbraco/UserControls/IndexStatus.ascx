        ...
        <ItemTemplate>
            <table>
                ...
                <tr class="hideByDefault">
                    ...
                    <td>
                        <%#
                            SupportUnpublishedContent(((ProviderSettings) Container.DataItem).Name)
                        %>
                ...
                <tr class="hideByDefault">
                    ...
                    <td>
                         <%# 
                            EnableDefaultEventHandler(((ProviderSettings)Container.DataItem).Name)
                        %>
                ...
                <tr class="hideByDefault">
                    ...
                    <td id="<%# ((ProviderSettings)Container.DataItem).Name %>QueuedItems" class="queuedItems <%# ((ProviderSettings)Container.DataItem).Name %>">
                        <%# QueuedFiles(((ProviderSettings)Container.DataItem).Name)%>
                    </td>
                </tr>
                  <tr class="hideByDefault">
                    <td class="label">
        ...
        <ItemTemplate>
            <table>
                ...
                <tr class="hideByDefault">
                    ...
                    <td>
                        <%# ((LuceneSearcher) ExamineManager.Instance.SearchProviderCollection[((ProviderSettings)Container.DataItem).Name]).Name %>
                    </td>
                </tr>
                <tr class="hideByDefault">
                    <td class="label">
                    ...
                    <td>
                        <%# ((LuceneSearcher) ExamineManager.Instance.SearchProviderCollection[((ProviderSettings)Container.DataItem).Name]).EnableLeadingWildcards %>
                    </td>
                </tr>
                <tr class="hideByDefault">
                    <td class="label">
                    ...
                    <td>
                        <%# ((LuceneSearcher) ExamineManager.Instance.SearchProviderCollection[((ProviderSettings)Container.DataItem).Name]).IndexingAnalyzer.GetType().FullName %>
                    </td>
                </tr>
                <tr class="hideByDefault">
                    <td class="label">
                    ...
                    <td>
                        <%# ((LuceneSearcher) ExamineManager.Instance.SearchProviderCollection[((ProviderSettings)Container.DataItem).Name]).LuceneIndexFolder.FullName %>
                    </td>
                </tr>
            </table>
        </ItemTemplate>
