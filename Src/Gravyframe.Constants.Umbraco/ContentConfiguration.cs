...
namespace Gravyframe.Configuration.Umbraco
{
    ...
    /// The content configuration.
    /// </summary>
    public class ContentConfiguration : Configuration.ContentConfiguration
    {
         /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ContentConfiguration"/> class. 
        /// </summary>
        ...
        /// </param>
        public ContentConfiguration(INodeFactoryFacade nodeFactoryFacade, int configurationNodeId)
        {
